...
sent_data = "10010101011000111001010011101100"
received_data = "10000101011000111001010011101101"
packet_count = 4
packet_length = int(len(sent_data)/packet_count)


def calc_sender_checkSum(data, k):
...
def main():
    calc_sender_checkSum(sent_data, packet_length)
